...
export const metadata: Metadata = {
  title: "Book a Discovery Call | ClearPath Technologies",
  description:
      ...
      <Container className="relative">
        ...
        <Reveal className="max-w-4xl">
          ...
          <p className="mt-7 max-w-3xl text-base leading-7 text-secondary sm:text-lg sm:leading-8">
            A ClearPath discovery call is a focused working conversation. We’ll discuss how work moves through your organization today, where bottlenecks exist, and where better systems could create measurable operational leverage.
          </p>
        </Reveal>
