      ...
      <Container>
        ...
        <Stagger className="grid gap-5 md:grid-cols-3">
          {site.insights.map((insight) => (
            <MotionCard key={insight.title} className="group flex min-h-72 flex-col rounded-xl border border-line p-7 transition-colors hover:border-muted hover:bg-surface/70">
