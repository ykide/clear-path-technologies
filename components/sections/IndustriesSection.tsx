  ...
  return (
    <Section id="industries">
      <Container>
        ...
        <Stagger className="grid overflow-hidden rounded-2xl border border-line sm:grid-cols-2 lg:grid-cols-5">
          {site.industries.map((industry, index) => (
            <MotionCard key={industry.title} className="-mb-px -mr-px border-b border-r border-line bg-surface p-6 transition-colors hover:bg-card">
